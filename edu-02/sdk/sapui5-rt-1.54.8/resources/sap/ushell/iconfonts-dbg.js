        ...
        iconfonts.registerFiori2IconFont = function () {
            ...
            var oLaunchpadIcons = {
                    ...
                    icons : [
                        ...
                        ["icon-money-withdrawal", "E0E7"], ["icon-truck-load", "E0E8"], ["icon-truck-load-unload", "e0ea"], ["icon-truck-unload", "e0e9"], ["icon-pharmacy", "e0eb"], ["icon-medicine-syrup", "e0ec"],
                        ["icon-reminder", "e0ed"], ["icon-medicine-pill", "e0ee"], ["icon-medicine-ointment", "e0ef"], ["icon-medicine-drops", "e0f0"], ["icon-blood-test", "e0f1"], ["icon-temperature", "e0f2"],
                        ["icon-allergies", "e0f9"], ["icon-immunization", "e0f8"], ["icon-blood-pressure", "e0f7"], ["icon-health-tracking", "e0f6"], ["icon-weight", "e0f5"],
                        ["icon-foot-steps", "e0f4"], ["icon-medicine-inhaler", "e0f3"], ["icon-rescheduling2", "e0fa"], ["icon-resequencing2", "e0fb"], ["icon-no-time-change", "e0fc"],
                        ["icon-time-change", "e0fd"], ["icon-smart-matcher", "e0fe"], ["icon-3D", "e0ff"], ["icon-parallel-sequence", "e100"],
                        ["icon-alternative-sequence", "e101"], ["icon-main-sequence", "e102"], ["icon-refinery", "e103"], ["icon-terminal", "e104"],
                        ["icon-vessel", "e105"], ["icon-barge", "e106"], ["icon-road", "e107"], ["icon-pipeline", "e108"],
                        ["icon-delay", "e109"],["icon-legal-section", "e10a"],["icon-causes", "e10b"],["icon-effects", "e10c"],["icon-shared-by-me", "e10d"],["icon-shared-with-me", "e10e"],
                        ["icon-main-milestone", "e10f"], ["icon-indicator-groups", "e110"]
                    ]
                },
                ...
                oTNTIcons = {
                    ...
                    icons: [
                        ...
                        ["Boundary interrupting", "e038"], ["Boundary non-interrupting", "e039"],  ["Block", "e03A"],
                        ["Constrain block", "e03B"], ["Actor", "e03C"], ["Instance specification", "e03D"],
                        ["Value type", "e03E"], ["Interface block", "e03F"], ["Unit", "e040"],
                        ["Signal", "e041"], ["Quantity kind", "e042"], ["Item flow", "e043"],
                        ["Dependency", "e044"], ["Generalization", "e045"], ["Aggregation", "e046"],
                        ["Composition", "e047"], ["Association", "e048"], ["Port", "e049"],
                        ["Proxy port", "e04A"], ["Full port", "e04B"], ["Operations", "e04C"],
                        ["Constrains", "e04D"], ["Receptions", "e04E"], ["References", "e04F"],
                        ["Parts", "e050"], ["Flow", "e051"], ["Values", "e052"],
                        ["Bill of material", "e053"], ["Document info recording", "e054"]
                    ]
                },
                oFioriInApp = {
