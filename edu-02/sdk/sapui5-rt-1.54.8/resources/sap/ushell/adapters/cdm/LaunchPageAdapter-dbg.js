...
], function ( Text, GenericTile, oGenericTileMode, oResources, oUtilsCdm, oUshellUtils, navigationMode) {
    "use strict";
     ...
     function LaunchPageAdapter (oUnused, sParameter, oAdapterConfiguration) {
        ...
        this._resolveTileByAppId = function(oTile, oSite) {
            ...
            var oMapped = oUtilsCdm.mapOne(oInboundResult.key, oInboundResult.inbound, oAppDescriptor),
                ...
                bIsApplicationTypeConfiguredInPlace = sap.ushell.Container.getService("ClientSideTargetResolution").isInPlaceConfiguredFor(sApplicationType);
        ...
        this._isFormFactorSupported = function(oAppDescriptor) {
            ...
            return oAppDescriptor.deviceTypes && oAppDescriptor.deviceTypes[sCurrentFormFactor];
        };
                ...
                .done(function (oSite) {
                    ...
                    oSite.site.payload.groupsOrder.forEach(function (sGroupId, iIndex) {
                        ...
                        if (oGroup) {
                            ...
                            aItemPromises = that._assureGroupItemsResolved(oGroup, oSite).concat(aItemPromises);
                        }
                    });
        ...
        this.getTileIndicatorDataSource = function (oTile) {
            ...
            if (oResolutionResult.indicatorDataSource) {
                ...
                // extract and add the dataSource to the results
        ...
        this._getTileUiComponentContainer = function (oTile, oResolvedTile, bIsCatalogTile) {
            ...
            return bIsCustomTile ? _customTileCreateCompContainer(): jQuery.when(_standardTileCreateCompContainer());
         };
        ...
        this._getCatalogTileView = function (oCatalogTile) {
            ...
            if (typeof oCatalogTile !== "object") {
                return new jQuery.Deferred().reject(oCatalogTile);
            }
