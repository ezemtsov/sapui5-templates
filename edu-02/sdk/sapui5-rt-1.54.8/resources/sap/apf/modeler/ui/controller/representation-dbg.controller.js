...
sap.ui.define([
	...
	"sap/apf/modeler/ui/utils/representationTypesHandler",
	"sap/apf/modeler/ui/utils/viewValidator"
], function(RepresentationHandler, uiConstants, coreConstants, nullObjectChecker, optionsValueModelBuilder, SortDataHandler, RepresentationBasicDataHandler, StepPropertyMetadataHandler, RepresentationTypesHandler, ViewValidator) {
	'use strict';
	...
	sap.ui.controller("sap.apf.modeler.ui.controller.representation", {
		onInit : function() {
			...
			oRepresentationTypeHandler = new RepresentationTypesHandler(oCoreApi.getRepresentationTypes());
			this.oViewValidator = new ViewValidator(this.getView());
		...
		handleChangeForChartType : function(oEvent) {
			...
			if (!oRepresentationTypeHandler.isChartTypeSimilar(sOldRepresentationType, sNewRepresentationType)) {
				...
				_setDefaultStateForRepnAsPromise(sNewRepresentationType).done(function() {
					oRepresentationBasicDataHandler.instantiateBasicDataAsPromise();
