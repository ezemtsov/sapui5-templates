 ...
 */
sap.ui.define(["sap/ui/base/Object", "sap/ui/model/FilterOperator", "sap/ui/model/Filter", 'sap/ui/mdc/base/type/Boolean', 'sap/ui/mdc/base/type/String'],

	function(BaseObject, ModelOperator, Filter, NullableBoolean, UppercaseString) {
		"use strict";
		...
		FilterOperatorConfig._addOperatorTo({
			...
			format: function(aValues, oContext, oType) {
				...
				var displayFormat = oType && oType.oFormatOptions && oType.oFormatOptions.displayFormat ? oType.oFormatOptions.displayFormat : "DescriptionValue";
		...
		*/
		...
		FilterOperatorConfig.createControl = function(oDataType, oOperator, sPath, index) {
			...
			if (oDataType && oDataType.sName === "Boolean") { //TODO oDataType instanceof sap.ui.model.type.Boolean
			...
			} else if (oDataType && oDataType.sName === "Integer") {
				jQuery.extend(true, oDataType.oFormatOptions, { emptyString: null });
				if (oDataType instanceof sap.ui.model.type.Integer) {
			...
			} else if (oDataType && oDataType.sName === "Float") { //TODO type instanceof sap.ui.model.type.Float
				jQuery.extend(true, oDataType.oFormatOptions, { emptyString: null });
				if (oDataType instanceof sap.ui.model.type.Integer) {
			...
			} else if (oDataType && oDataType.sName === "Date") { //TODO type instanceof sap.ui.model.type.Date
				return new sap.m.DatePicker({
					value: { path: sPath, type: oDataType, mode: 'TwoWay' }
				});
			} else if (oDataType && oDataType.sName === "Time") { //TODO oDataType instanceof sap.ui.model.type.Time
