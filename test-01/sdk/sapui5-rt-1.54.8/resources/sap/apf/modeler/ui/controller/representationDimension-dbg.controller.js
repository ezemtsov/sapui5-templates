...
sap.ui.define([
...
], function(constants, BaseController, DisplayOptionsValueBuilder, textManipulator) {
	"use strict";
	/* BEGIN_COMPATIBILITY */
	...
	return BaseController.extend("sap.apf.modeler.ui.controller.representationDimension", {
		setLabelDisplayOptionTypeAsPromise : function(optionsValueModelBuilder) {
			...
			displayOptionsValueBuilder = new DisplayOptionsValueBuilder(oController.oTextReader, optionsValueModelBuilder);
			oLabelDisplayOptions = constants.representationMetadata.labelDisplayOptions;
			sPropertyName = textManipulator.removePrefixText(oController.byId("idPropertyType").getSelectedKey(), oController.oTextReader(sap.apf.modeler.ui.utils.CONSTANTS.texts.NOTAVAILABLE));
		...
		changeLabelDisplayOption : function(sLabelDisplayOption){
			var oController = this;
			var sProperty = textManipulator.removePrefixText(oController.byId("idPropertyType").getSelectedKey(), oController.oTextReader(sap.apf.modeler.ui.utils.CONSTANTS.texts.NOTAVAILABLE));
			oController.oRepresentation.setLabelDisplayOption(sProperty, sLabelDisplayOption);
		},
		removePropertyFromParentObject : function() {
			var oController = this;
			oController.oRepresentation.removeDimension(textManipulator.removePrefixText(oController.byId("idPropertyType").getSelectedKey(), oController.oTextReader(sap.apf.modeler.ui.utils.CONSTANTS.texts.NOTAVAILABLE)));
		},
