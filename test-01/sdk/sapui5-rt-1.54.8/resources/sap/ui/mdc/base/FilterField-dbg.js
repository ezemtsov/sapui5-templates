 ...
 */
sap.ui.define(['jquery.sap.global', 'sap/ui/core/Control', 'sap/ui/model/json/JSONModel', './FilterFieldRenderer', 'sap/m/MultiInput', 'sap/m/Token', 'sap/ui/model/Filter', 'sap/ui/model/Sorter', "sap/ui/model/base/ManagedObjectModel", "sap/ui/base/ManagedObjectObserver", "sap/ui/mdc/base/type/DateRange", 'sap/ui/mdc/library'],
	function(jQuery, Control, JSONModel, FilterFieldRenderer, MultiInput, Token, Filter, Sorter, ManagedObjectModel, ManagedObjectObserver, DateRange, library) {
		"use strict";
		...
		FilterField.prototype._handleTokenUpdate = function(oEvent) {
			...
			if (sEvent === "change") {
				...
				jQuery.sap.log.info("mdc:FilterField", "_handleTokenUpdate sValue " + sValue);
				...
				if (this.getFieldHelp()) {
					if (jQuery.sap.containsOrEquals(this.getFieldHelp()._getPopover().getFocusDomRef(), document.activeElement)) {
						return;
					}
					if (this.getFieldHelp()._getPopover().isOpen() && this.getFieldHelp().getProperty("selectedKey")) {
						return;
					}
				}
