...
sap.ui.define([
	...
	sap.ui.getCore().initLibrary({
		...
		types: [
			"sap.ui.comp.smartfield.ControlProposalType", "sap.ui.comp.smartfield.ControlContextType", "sap.ui.comp.smartfield.ControlType", "sap.ui.comp.smartfield.DisplayBehaviour", "sap.ui.comp.smartfield.JSONType", "sap.ui.comp.smartfield.CriticalityRepresentationType", "sap.ui.comp.smartfield.TextInEditModeSource", "sap.ui.comp.smarttable.TableType", "sap.ui.comp.smarttable.ExportType", "sap.ui.comp.smartlist.ListType", "sap.ui.comp.personalization.AggregationRole", "sap.ui.comp.personalization.ResetType", "sap.ui.comp.personalization.ChangeType", "sap.ui.comp.valuehelpdialog.ValueHelpRangeOperation", "sap.ui.comp.smartfilterbar.SelectOptionSign"
		],
		interfaces: [],
		controls: [
	...
	sap.ui.comp.smartform.inheritCostomDataToFields = function(oCustomData) {
		...
		var aBlacklist = [
			"sap.ui.fl:AppliedChanges", "sap.ui.fl.appliedChanges", "sap-ui-custom-settings"
		];
	...
	/**
	 * Enumeration of sources from which text values for <code>Codes</code>/<code>IDs</code> are fetched in edit mode.
	 *
	 * The text is usually visualized as description/text value for IDs, for example, for LT (Laptop).
	 *
	 * @enum {string}
	 * @public
	 * @since 1.54
	...
	sap.ui.comp.smartfield.TextInEditModeSource = {
		...
		/**
		 * The <code>com.sap.vocabularies.UI.v1.TextArrangement</code> annotation and the value of the
		 * <code>displayBehaviour</code> property of the <code>configuration</code> aggregation are not evaluated.
		 *
		 * @public
		 */
		None: "None",
		...
		/**
		 * The text is fetched from the OData model property specified in the <code>Path</code> attribute of
		 * the <code>com.sap.vocabularies.Common.v1.Text</code> annotation.
		 *
		 * @public
		 */
		...
		/**
		 * The text is fetched from the OData model property specified in the <code>Path</code> attribute of
		 * the <code>com.sap.vocabularies.Common.v1.Text</code> annotation of the associated value list entity.
		 *
		 * @public
		 */
		ValueList: "ValueList"
