	...
	var vfdController = Controller.extend("sap.suite.ui.generic.template.AnalyticalListPage.controller.VisualFilterDialogController", {
		...
		*/
					...
					new Button({
						...
						press: function(oEvent) {
							if (bIsValuehelp) {
								...
								var bIsEntitySearchable = that.oState.alr_visualFilterBar._isEntitytypeSearchable(this.getModel(), props.entitySet),
		...
		_showChartTypesPopup: function(oEvent) {
			...
			var i18nModel = button.getModel('i18n');
			var oDialog = sap.suite.ui.generic.template.AnalyticalListPage.controller.VisualFilterDialogController._createPopoverDialog(i18nModel, "VISUAL_FILTER_CHART_TYPES");
